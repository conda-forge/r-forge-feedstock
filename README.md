...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-forge-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-forge-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-forge-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-forge-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-forge-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-forge-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-forge` can be installed with:

```
conda install r-forge
```

It is possible to list all of the versions of `r-forge` available on your platform with:
